...
(function () {
  ...
  function injectLangbar() {
    if (document.getElementById('langbar')) return;          // page owns a langbar
    if (typeof window.setLang === 'function') return;        // page owns global setLang
    if (typeof window.setPxLang === 'function') return;      // prefectures scoped i18n
