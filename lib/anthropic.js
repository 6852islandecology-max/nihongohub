...
11. "explanation" field: 1-2 sentences in ${langName} explaining why the correct answer is right and briefly why each distractor is wrong. MUST be in ${langName} — NEVER in Japanese unless ${langName} is "Japanese". This is critical for non-Japanese learners.

Reply with ONLY this JSON object, nothing else before or after, no markdown fences:
{"question":"<japanese sentence with <u>...</u> and/or <ruby>...</ruby> as described>","reading":"<${langName} instruction>","correct":"<correct answer>","distractors":["<wrong1>","<wrong2>","<wrong3>"],"explanation":"<${langName} explanation, NEVER Japanese unless target lang is Japanese>","type":"${chosenType}"}`;
}
