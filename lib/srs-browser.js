/* [browser] SM-2 ベースの SRS。window.NH_SRS を生やす。
   quiz.html のクライアント側「間違い復習」で使う、唯一の SRS 実装。

   2026-07-24: かつて対になるサーバ用 lib/srs.js があり本ファイルはその写しだったが、
   lib/srs.js はどこからも呼ばれておらず（api/srs-due.js 等は存在しない）挙動も乖離していたため削除した。
   テストは scripts/test-srs.mjs がこのファイルを直接読み込んで検証する。
